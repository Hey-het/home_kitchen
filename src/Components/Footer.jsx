...
export default function FooterPage(){
    ...
    <footer className="w-full ">
        <div className="">
            <div className="max-w-full bg-gray-300">
            
                    <ul className="text-lg flex items-center justify-center flex-col  md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10  border-gray-200">
                        
                        <li><a href="#" className=" text-gray-800 hover:text-gray-900">Contact us</a></li>
                        <li><a href="#" className=" text-gray-800 hover:text-gray-900">Legel Terms</a></li>
                        <li><a href="#" className=" text-gray-800 hover:text-gray-900">Privacy Policy</a></li>
                        <li><a href="#" className=" text-gray-800 hover:text-gray-900">Cookie Policy</a></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center pb-10">
