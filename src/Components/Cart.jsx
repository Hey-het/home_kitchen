...
export default function CartPage({ orderSumbit, placeOrder, deleteItem, quantityUpdate}) {
  ...
  return (
    <div className="pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-4 m-10">
        {/* Cart Items */}
        <div className="w-full sm:w-[60%] border rounded-lg shadow-lg p-6 bg-white m-0 sm:m-10">
        ...
        {/* Summary Section */}
        <div className="max-w-md mx-auto bg-white shadow-lg rounded-lg border border-gray-200 p-4 mt-4 sm:mt-0">
